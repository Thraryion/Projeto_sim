...
if (!isset($_SESSION['loggedin']) || $_SESSION['departamento'] != '3') {
    // Redireciona para a página de login, caso não esteja logado ou não seja do departamento de SAC
...
// Prepara a consulta SQL para buscar as sugestões
...
<div class="container">
    <h1 class="text-center mt-3">Sugestões</h1>
    <table class="table mt-4">
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    <td><?php echo $row['id_sugestao']; ?></td>
                    <td><?php echo $row['sugestao']; ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
