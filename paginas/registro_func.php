...
<form method="POST" class="text-center border border-light p-5" action="../functions/cadastro_func_handle.php">
<div class="mb-3">
  ...
  <option value="0">Diretor de RH</option>
  <option value="1">RH</option>
  <option value="2">vendas</option>
  <option value="3">SAC</option>
  <option value="4">diretor de vendas</option>
