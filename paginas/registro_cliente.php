...
<form method="POST" class="text-center border border-light p-5" action="../functions/cadastro_cliente_handle.php">
<div class="mb-3">
  ...
  <select class="form-select" aria-label="Default select example" name="plano">
